...
'experiment_graph=~/collaborative-optimization/code/collaborative-optimizer/data/experiment_graphs/kaggle_home_credit/start_here_a_gentle_introduction/all' \
'update_graph=yes'
