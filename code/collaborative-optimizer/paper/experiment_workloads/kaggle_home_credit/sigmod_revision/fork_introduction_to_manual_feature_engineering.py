...
Custom fork of workload 2 and 4
This is generated script which forks 'introduction_to_manual_feature_engineering.py'


Description:
    The script trains a lgbm model with hyperparameters from cridata's script (Workload 4) on the the
    datasets of 'introduction_to_manual_feature_engineering' (Workload 2) script
...
def workload_6(execution_environment, root_data, verbose=0):
