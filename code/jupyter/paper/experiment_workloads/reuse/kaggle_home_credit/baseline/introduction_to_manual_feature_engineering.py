...
"""Baseline workload 2 for Home Credit Default Risk Competition
   The code here, is the original code posted as a notebook for the Kaggle competitiong.
   The notebook can be found here: https://www.kaggle.com/willkoehrsen/introduction-to-manual-feature-engineering
"""
...
def run(root_data):
    ...
    bureau_agg = bureau.drop(columns=['SK_ID_BUREAU']).groupby('SK_ID_CURR', as_index=False).agg(
