...
app_train = pd.read_csv(ROOT_DIRECTORY + '/home-credit-default-risk/application_train.csv')
print('Training data shape: ', app_train.shape)
app_train.head()

app_test = pd.read_csv(ROOT_DIRECTORY + '/home-credit-default-risk/application_test.csv')
