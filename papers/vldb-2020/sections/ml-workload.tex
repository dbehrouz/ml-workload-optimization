...
% Tilmann: Are these balanced? It seems to me that Hyper parameter training is part of the model training
\begin{table}
\centering
\begin{tabular}{ll}
\hline
...
When optimizing a new workload (i.e., a Kaggle kernel), we only utilize the connected component of the task which the workload is trying to solve (i.e., the Kaggle competition) and do not utilize the rest of the graph for optimization.
