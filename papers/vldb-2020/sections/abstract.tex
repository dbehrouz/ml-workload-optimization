...
However, collaborative platforms suffers from two inefficiencies.
...
Since storing all the artifacts is not feasible, we propose two algorithms for selecting the artifacts with high likelihood of future reuse.
