...
The platforms store the workloads either in a relational database using a predefined schema (OpenML) or as scripts which contain the actual analysis and training code (Kaggle).
