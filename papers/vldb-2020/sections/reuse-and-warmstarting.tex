...
\centering
\input{../images/tikz/reuse-example-wg.tex}
\caption{Workload Graph ($\mathcal{WG}$)}
\end{subfigure}%
\begin{subfigure}[t]{0.33\linewidth}
\centering
\input{../images/tikz/reuse-example-sg.tex}
\caption{Common Subgraph ($\mathcal{SG}$)}
\end{subfigure}%
\begin{subfigure}[t]{0.33\linewidth}
\centering
\input{../images/tikz/reuse-example-final.tex}
\caption{Optimized Graph}
\end{subfigure}
\begin{subfigure}[t]{\linewidth}
\centering
\input{../images/tikz/reuse-example-final-eg.tex}
...
\begin{figure}[t]
\centering
\input{../images/tikz/warmstarting-example-final-eg.tex}
