...
\subsubsection{Artifacts Unique Identifiers}
...
\todo[inline]{Do we need to discuss implementation details? I will utilize a Trie like method to name the vertices so essentially a vertex $v$ is identified by the sequence of operations that have been applied to the root node to transform it to $v$}
