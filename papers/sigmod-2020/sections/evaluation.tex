...
In our motivating example, we describe three workloads (Workloads 1-3 of Table \ref{kaggle-workload}).
...
In Workloads 2 and 3, CO outperforms KG even in the first run.
...
Since Workload 3 has large artifacts, HM exhausts its budget by materializing them (as explained in the materialization experiments).
