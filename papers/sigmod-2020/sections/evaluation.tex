...
\caption{Total run time of the workloads with different materialization algorithms and budgets \todo[inline]{plot the run time when all the artifacts are materialized as a baseline.}}
