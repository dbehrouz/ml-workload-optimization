...
Nectar \cite{gunda2010nectar} is a  cluster data management system, which also offers caching and reusing of intermediate data generated in DryadLINQ programs \cite{fetterly2009dryadlinq}.
