...
\node (m) [circle, draw,inner sep=0.03cm,pattern=crosshatch, pattern color = green] at (4.25,4.2) {$v_3$};
...
\node (m) [circle, draw,inner sep=0.03cm,pattern=crosshatch, pattern color = green] at (7.92,2.6) {$v_2$};
\node (m) [circle, draw,inner sep=0.03cm,pattern=crosshatch, pattern color = green] at (8.42,2.6) {$v_3$};
