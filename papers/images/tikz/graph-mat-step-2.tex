...
% layer 1
\node(v1) [materialized][circle, draw] at (-1.8,4.8){$v_1$};
\node(v2) [circle, draw] at (-0.2,4.8) {$v_2$};
% layer 2
\node(v3)[circle, draw] at (-1.8,3.8) {$v_3$};
\node (v4)[materialized][circle, draw] at (-1, 3.2) {$v_4$};
\node(v5)[materialized][circle, draw] at (-0.2, 3.8) {$v_5$};
%layer 3
\node(v6)[materialized][circle, draw] at (-1.8, 2.5) {$v_6$};
\node(v7)[materialized][circle, draw] at (-0.2,2.5) {$v_7$};
\graph [edges ={thick}]{
(v0)
